...
*/
            ...
            int iPrevPilotKeyDownIndex=0;
                
            for(iPrevPilotKeyDownIndex=0; iPrevPilotKeyDownIndex<MAX_ROBOTSHIP_COUNT; iPrevPilotKeyDownIndex++) {
/*
                if (iPrevPilotKeyDownContainer[iPrevPilotKeyDownIndex]-(1-iPrevPilotKeyDownIndex)<0) {
                    iPrevPilotKeyDownContainer[iPrevPilotKeyDownIndex]=iArrayPilotKeyDownHistoryContainer[MAX_PILOT_KEY_DOWN_HISTORY-(1+iPrevPilotKeyDownIndex)];
                }
                else {
                    iPrevPilotKeyDownContainer[iPrevPilotKeyDownIndex]=iArrayPilotKeyDownHistoryContainer[iPilotKeyDownCount-(1+iPrevPilotKeyDownIndex)];
                }
*/
...
/*
                //note: Robo's distance notioceably near with Pilot
                switch (iPrevPilotKeyDownContainer[iPrevPilotKeyDownIndex]) {
                    case FACING_UP:
                        if ((myRobotshipContainer[iPrevPilotKeyDownIndex]->getCurrentFacing()==FACING_LEFT) || (myRobotshipContainer[iPrevPilotKeyDownIndex]->getCurrentFacing()==FACING_RIGHT)) {
                            myRobotshipContainer[iPrevPilotKeyDownIndex]->setYPos(myPilot->getY());
                        }
                        else {
                            myRobotshipContainer[iPrevPilotKeyDownIndex]->setYPos(myPilot->getY()+myPilot->getHeight()*0.5f);
                        }
                        myRobotshipContainer[iPrevPilotKeyDownIndex]->setXPos(myPilot->getX());
                        break;
                    case FACING_DOWN:
                        if ((myRobotshipContainer[iPrevPilotKeyDownIndex]->getCurrentFacing()==FACING_LEFT) || (myRobotshipContainer[iPrevPilotKeyDownIndex]->getCurrentFacing()==FACING_RIGHT)) {
                            myRobotshipContainer[iPrevPilotKeyDownIndex]->setYPos(myPilot->getY());
                            ...
                            myRobotshipContainer[iPrevPilotKeyDownIndex]->setYPos(myPilot->getY()-myRobotshipContainer[iPrevPilotKeyDownIndex]->getHeight()*0.5f);
                        }
                        myRobotshipContainer[iPrevPilotKeyDownIndex]->setXPos(myPilot->getX());
                        break;
                    case FACING_LEFT:
                        if ((myRobotshipContainer[iPrevPilotKeyDownIndex]->getCurrentFacing()==FACING_UP) || (myRobotshipContainer[iPrevPilotKeyDownIndex]->getCurrentFacing()==FACING_DOWN)) {
                            myRobotshipContainer[iPrevPilotKeyDownIndex]->setXPos(myPilot->getX());
                        }
                        else {
                            myRobotshipContainer[iPrevPilotKeyDownIndex]->setXPos(myPilot->getX()-myRobotshipContainer[iPrevPilotKeyDownIndex]->getWidth()*0.5f);
                        }
                        myRobotshipContainer[iPrevPilotKeyDownIndex]->setYPos(myPilot->getY());
                        break;
                    case FACING_RIGHT:
                        if ((myRobotshipContainer[iPrevPilotKeyDownIndex]->getCurrentFacing()==FACING_UP) || (myRobotshipContainer[iPrevPilotKeyDownIndex]->getCurrentFacing()==FACING_DOWN)) {
                            ...
                            myRobotshipContainer[iPrevPilotKeyDownIndex]->setXPos(myPilot->getX()+myPilot->getWidth()*0.5f);
                        }
                        myRobotshipContainer[iPrevPilotKeyDownIndex]->setYPos(myPilot->getY());
                        break;
                }
...
/*
                //note: -1 default value; no directional movement
                myRobotshipContainer[iPrevPilotKeyDownIndex]->move(iPrevPilotKeyDownContainer[iPrevPilotKeyDownIndex]);
                //                myRobotship->move(iPrevPilotKeyDown);
*/
            }
